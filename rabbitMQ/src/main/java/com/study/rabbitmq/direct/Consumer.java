            ...
            try {
                ...
                channel.basicConsume(queueName, true, new DeliverCallback() {
                    public void handle(String consumerTag, Delivery message) throws IOException {
                        System.out.println(queueName + "接受到的消息是:" + new String(message.getBody(), "UTF-8"));
                    }
                }, new CancelCallback() {
...
//             System.in.read();
    ...
    public static void main(String[] args) {
        new Thread(runnable, "queuel1").start();
        new Thread(runnable, "queuel2").start();
        new Thread(runnable, "queuel3").start();
